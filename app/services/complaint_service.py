...
async def create_complaint(
    ...
    # 5. Resolution-specific actions at creation
    ...
    # Note: for "discount" resolution, coupon is NOT created here.
    # Coupon is generated by admin when they approve the complaint.
